...
public class CardsDto {
	...
	public CardsDto(
			...
			@Positive(message = "Total card limit should be greater than zero") int totalLimit,
			@PositiveOrZero(message = "Total amount used should be equal or greater than zero") int amountUsed,
